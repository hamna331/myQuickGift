...
function Gallery() {
  return (
    <>
      <div class="container-fluid  page-title-2 d-flex align-items-center justify-content-center">
        <div className=" text text-light ">
          <h1 className="d-flex justify-content-center">GALLERY</h1>
          <p className="text-light text-center">
            Our gift wrapping exudes love and creativity, carefully crafted to
            make yours the present that stands out among the crowd. Elevate your
            gift-giving experience with our touch of elegance!
          </p>
        </div>
      </div>
      ...
      <div className="hero d-flex align-items-start justify-content-center ">
        <div className="text-center">
          <h2 className=" text-white ">
            Transforming gifts one bow at a time.
          </h2>
          <button
            type="button"
            className=" btn-primary-1"
            routerLink="/book-services"
          >
            BOOK NOW
          </button>
        </div>
