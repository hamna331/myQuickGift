...
function Footer() {
  ...
  <div className="container">
    <div className="row">
      <div className="col-lg-3 col-md-6 col-sm-12 mt-0">
        ...
        <p className="mb-1 text-white mt-0">(929) 374-7424</p>
        <a href="mailto:contactus@quickwrapgifts.com" className=" mail mb-2 text-white">contactus@quickwrapgifts.com</a>
        <div className="d-flex social-media-icons mb-2 text-white mt-0 pt-0">
          <a href="/"><img src={you} alt="logo" /></a>
          <a href="/"><img src={ti} alt="logo" /></a>
          <a href="/"><img src={ins} alt="logo" /></a>
          <a href="/"><img src={tw} alt="logo" /></a>
          <a href="/"><img src={fb} alt="logo" /></a>
          <a href="/"><img src={li} alt="logo" /></a>
        </div>
      </div>
      <div className="col-lg-8 col-md-6 col-sm-12   ">
        <ul
          className="list-unstyled d-flex justify-content-evenly footer-links "
        >
  ...
  <div className="d-flex justify-content-center m-0">
    <p className="text-white mt-0">© 2023 Quick Wrap Gifts | All Rights are Reserved</p>
  </div>
</div>
